...
public class DemoTest02 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL(actions.getData("./Excel/DetailsPage.xlsx","Sheet1",1,2));
        ...
        try
        {
            actions.EnterData(new MhLoginPage(driver).username,actions.getData("./Excel/DetailsPage.xlsx","Sheet1",1,0));
        ...
        try
        {
            actions.EnterData(new MhLoginPage(driver).password,actions.getData("./Excel/DetailsPage.xlsx","Sheet1",1,1));
